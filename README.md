...
__1. When evaluting the left read of paired-end reads (R1), the right read (or R2) often has lower quality than the left read from Illumina sequencing. Why and how to mitigate this?__
...
__2. If we discard the low‑quality R2 reads and end up with unequal read counts between R1 and R2, can we still proceed to the alignment step?__
